...
public class Java11GetBodyTest {
    ...
    void bodyContainsCurrentUserUrl() throws IOException, InterruptedException {
        ...
        HttpRequest get = HttpRequest.newBuilder(URI.create(BASE_URL + "users/kristinamarkova"))
        ...
        // Assert
        assertTrue(body.contains("\"login\":\"kristinamarkova\""));
    }
    ...
    void handleJsonBody() throws IOException, InterruptedException {
        ...
        Assertions.assertEquals("kristinamarkova", actualLogin);
    }
}
